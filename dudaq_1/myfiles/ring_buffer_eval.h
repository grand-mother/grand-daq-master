...
// array of buffer
    ...
    float *a_prob; // array of probability given by evaluation
...
uint8_t
RFE_delete (RingBufferEval_struct **pp_rbe);

inline void
RFE_update_write (RingBufferEval_struct *p_rbe);

inline void
RFE_update_eval (RingBufferEval_struct *p_rbe);

inline void
RFE_update_trigger (RingBufferEval_struct *p_rbe);

inline void
RFE_inc_modulo(uint16_t *p_int, uint16_t max_int);

void
RFE_print_error(void);

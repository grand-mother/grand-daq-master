...
main ()
{
  ...
  unsigned short ctrllist[9] =
    { 0x0199, 0x12, CTRL_SEND_EN | CTRL_PPS_EN, 0xff00 | TRIG_10SEC | TRIG_EXT,
	0x000f, 0x0010, 0, 0, 0x6666 };
  unsigned short winlist[11] =
    { 0x299, 0x16, 0x50, 0x54, 0x52, 0x56, 0x54, 0x58, 0x56, 0x5a, 0x6666 };
  unsigned short chlist[9] =
    { 0x0899, 0x12, 0x4000, 0x0080, 0x2100, 0x1900, 0x0, 0x0, 0x6666 };
  unsigned short trlist[9] =
    { 0x0C99, 0x12, 0xa0, 0xa0, 0x50c8, 0xff64, 0xff00, 0x0, 0x6666 };
  unsigned short fltlist[11] =
    { 0x1099, 0x16, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x6666 };
  ...
  while (1)
    {
      if (scope_no_run_read () == SCOPE_GPS)
	scope_calc_evnsec ();
    }
  scope_close ();
  return (1);

\doxysection{/\+Users/timmer/\+Library/\+Mobile Documents/com\texorpdfstring{$\sim$}{\string~}apple\texorpdfstring{$\sim$}{\string~}\+Cloud\+Docs/\+Cloud\+Work/\+GRAND/grand-\/daq-\/master/\+DU/buffer.c File Reference}
\hypertarget{_d_u_2buffer_8c}{}\label{_d_u_2buffer_8c}\index{/Users/timmer/Library/Mobile Documents/com\texorpdfstring{$\sim$}{\string~}apple\texorpdfstring{$\sim$}{\string~}CloudDocs/CloudWork/GRAND/grand-\/daq-\/master/DU/buffer.c@{/Users/timmer/Library/Mobile Documents/com\texorpdfstring{$\sim$}{\string~}apple\texorpdfstring{$\sim$}{\string~}CloudDocs/CloudWork/GRAND/grand-\/daq-\/master/DU/buffer.c}}
...
\item 
\Hypertarget{_d_u_2buffer_8c_a35b25e20a503af211a32c26902fa0878}\label{_d_u_2buffer_8c_a35b25e20a503af211a32c26902fa0878} 
\#define {\bfseries MAXDT}~1.e-\/5
\begin{DoxyCompactList}\small\item\em max 10 musec difference with T3 time \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{_d_u_2buffer_8c_a422738ac07c4d1144b86d381a69e94e4}\label{_d_u_2buffer_8c_a422738ac07c4d1144b86d381a69e94e4} 
int {\bfseries buffer\+\_\+to\+\_\+t3} (unsigned short event\+\_\+nr, unsigned short isec, unsigned int ssec, uint16\+\_\+t trflag)
\item 
int \mbox{\hyperlink{_d_u_2buffer_8c_ae48450a3bbf03edb76ed26b6fb3b272d}{buffer\+\_\+add\+\_\+t2}} (unsigned short \texorpdfstring{$\ast$}{*}bf, int bfsize, short id)
...
int \mbox{\hyperlink{_d_u_2buffer_8c_ad88a35049377df2a04710c8dfeac462d}{buffer\+\_\+add\+\_\+t3}} (unsigned short \texorpdfstring{$\ast$}{*}bf, int bfsize, short id)
...
int \mbox{\hyperlink{_d_u_2buffer_8c_a43c8c03988ffb9cea769fb76d336d009}{buffer\+\_\+add\+\_\+monitor}} (unsigned short \texorpdfstring{$\ast$}{*}bf, int bfsize, short id)
\begin{DoxyCompactList}\small\item\em add monitor events into the output buffer \end{DoxyCompactList}\item 
int \mbox{\hyperlink{_d_u_2buffer_8c_ac34f6a3c907435633dc89c1e8f30fc13}{print\+\_\+message}} (\mbox{\hyperlink{struct_a_m_s_g}{AMSG}} \texorpdfstring{$\ast$}{*}msg)
\begin{DoxyCompactList}\small\item\em prints message in hex and dec (debugging purposes) \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsubsection*{Variables}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{_d_u_2buffer_8c_a711643b10fc558f909694d5147286d09}\label{_d_u_2buffer_8c_a711643b10fc558f909694d5147286d09} 
\mbox{\hyperlink{struct_e_v___d_a_t_a}{EV\+\_\+\+DATA}} {\bfseries t3\+\_\+buffer} \mbox{[}\mbox{\hyperlink{_d_u_2scope_8h_a52cc46c3561fc6bbe5af1bff78ff6303}{MAXT3}}\mbox{]}
\begin{DoxyCompactList}\small\item\em buffer of T3 events that need to be transferred to the DAQ \end{DoxyCompactList}\item 
\Hypertarget{_d_u_2buffer_8c_a32c835e83eeea38bf6a37fa864a1c07b}\label{_d_u_2buffer_8c_a32c835e83eeea38bf6a37fa864a1c07b} 
int32\+\_\+t {\bfseries t3\+\_\+wait} =0
\begin{DoxyCompactList}\small\item\em the pointer to the last event waiting to be sent \end{DoxyCompactList}\item 
\Hypertarget{_d_u_2buffer_8c_ada2ebb70af6fd5ecd043d7c0004155a6}\label{_d_u_2buffer_8c_ada2ebb70af6fd5ecd043d7c0004155a6} 
int32\+\_\+t {\bfseries t3\+\_\+send} =0
\begin{DoxyCompactList}\small\item\em the pointer to the last event that was sent \end{DoxyCompactList}\item 
\Hypertarget{_d_u_2buffer_8c_a0b3ad6f4f8f4b807b90fcd5de25b485b}\label{_d_u_2buffer_8c_a0b3ad6f4f8f4b807b90fcd5de25b485b} 
...
\Hypertarget{_d_u_2buffer_8c_a243df20e2497f32e6fe4835b594b2d52}\label{_d_u_2buffer_8c_a243df20e2497f32e6fe4835b594b2d52} 
...
\Hypertarget{_d_u_2buffer_8c_ac99d896f3e702d9236d640e7a8fd1f6f}\label{_d_u_2buffer_8c_ac99d896f3e702d9236d640e7a8fd1f6f} 
...
\Hypertarget{_d_u_2buffer_8c_ae10976f7e77b1c4bcb87aaabdee78121}\label{_d_u_2buffer_8c_ae10976f7e77b1c4bcb87aaabdee78121} 
int {\bfseries evread}
\begin{DoxyCompactList}\small\item\em pointer to the last event read \end{DoxyCompactList}\item 
\Hypertarget{_d_u_2buffer_8c_acac741c0dd6b0e151ab4669236de50a6}\label{_d_u_2buffer_8c_acac741c0dd6b0e151ab4669236de50a6} 
...
\Hypertarget{_d_u_2buffer_8c_a991f8889cfdcd9c7db60dbf94781604a}\label{_d_u_2buffer_8c_a991f8889cfdcd9c7db60dbf94781604a} 
int32\+\_\+t {\bfseries evgps}
\begin{DoxyCompactList}\small\item\em pointer to next GPS info \end{DoxyCompactList}\item 
\Hypertarget{_d_u_2buffer_8c_a7935548448144453a965ca585433be6a}\label{_d_u_2buffer_8c_a7935548448144453a965ca585433be6a} 
...
\Hypertarget{_d_u_2buffer_8c_a9710d9c5d4b501d35384db6ee928dc6f}\label{_d_u_2buffer_8c_a9710d9c5d4b501d35384db6ee928dc6f} 
float \texorpdfstring{$\ast$}{*} {\bfseries ch\+\_\+volt}
\item 
\Hypertarget{_d_u_2buffer_8c_a28b4ca647ffdaa6bd4599b4c1768bfc7}\label{_d_u_2buffer_8c_a28b4ca647ffdaa6bd4599b4c1768bfc7} 
...
\Hypertarget{_d_u_2buffer_8c_a43c8c03988ffb9cea769fb76d336d009}\label{_d_u_2buffer_8c_a43c8c03988ffb9cea769fb76d336d009} 
...
C. Timmermans 
\end{DoxyAuthor}
\Hypertarget{_d_u_2buffer_8c_ae48450a3bbf03edb76ed26b6fb3b272d}\label{_d_u_2buffer_8c_ae48450a3bbf03edb76ed26b6fb3b272d} 
...
C. Timmermans 
\end{DoxyAuthor}
\Hypertarget{_d_u_2buffer_8c_ad88a35049377df2a04710c8dfeac462d}\label{_d_u_2buffer_8c_ad88a35049377df2a04710c8dfeac462d} 
...
C. Timmermans 
\end{DoxyAuthor}
\Hypertarget{_d_u_2buffer_8c_ac34f6a3c907435633dc89c1e8f30fc13}\label{_d_u_2buffer_8c_ac34f6a3c907435633dc89c1e8f30fc13} 
\index{buffer.c@{buffer.c}!print\_message@{print\_message}}
\index{print\_message@{print\_message}!buffer.c@{buffer.c}}
\doxysubsubsection{\texorpdfstring{print\_message()}{print\_message()}}
{\footnotesize\ttfamily int print\+\_\+message (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{struct_a_m_s_g}{AMSG}} \texorpdfstring{$\ast$}{*}}]{msg }\end{DoxyParamCaption})}



prints message in hex and dec (debugging purposes) 


\begin{DoxyParams}{Parameters}
{\em msg} & pointer to message \\
\hline
\end{DoxyParams}
